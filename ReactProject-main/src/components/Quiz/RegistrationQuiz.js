  ...
  const handleSubmit = (event) => {
    ...
    fetch(url + "/users/register", {
      ...
      body: JSON.stringify({
        ...
        cardioExercise: localStorage.getItem("cardioExercise"),
        relaxationExercise: localStorage.getItem("relaxationExercise"),
        strengthExercise: localStorage.getItem("strengthExercise"),
        stretchingExercise: localStorage.getItem("stretchingExercise"),
        memeExercise: localStorage.getItem("memeExercise"),
      }),
      headers: {
